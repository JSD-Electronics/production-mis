...
const Profile = ({ params }: { params: { id: string } }) => {
  ...
  React.useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        ...
        const coverPic = result.user.coverPic;
  ...
  const uploadCoverPic = async (e: any) => {
    ...
    const result = await uploadCoverPicture(params.id, formData);
  ...
  const uploadProfilePic = async (e: any) => {
    ...
    const result = await uploadProfilePicture(params.id, formData);
    const filePath = result.user.profilePic;
    const normalizedFilePath = filePath.replace(/\\/g, "/");
    setProfilePicture(
      `${CONFIG.BASE_URL}/${normalizedFilePath}`,
  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-242.5">
        <Breadcrumb parentName="" pageName="Profile" />
            ...
            <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="relative drop-shadow-2">
                <Image
                  ...
                  width={160}
                  height={160}
                  className="rounded-full object-cover" // Added classes for rounded and cover
                  alt="profile"
                  style={{
                    borderRadius: "50%",
                    maxHeight: "160px",
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                ...
                <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                  ...
                  <span className="text-sm">UPHA</span>
                </div>
              </div>
