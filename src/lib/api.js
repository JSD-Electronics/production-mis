...
export const getAllMenus = async () => {
  try {
    ...
    const alreadyHasLiveDashboard = menus.some((m) => {
      const label = (m?.label || "").toString().trim().toLowerCase();
      const route = (m?.route || "").toString().trim().toLowerCase();
    ...
    const liveDashboardMenu = {
      label: "Live Dashboard",
      route: "/live-dashboard",
      icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4h16a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H7l-3 3V6a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="1.5"/><path d="M8 9h8M8 13h5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
      children: [],
    };
