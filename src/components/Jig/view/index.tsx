...
import { viewJig, deleteJig, deleteMultipleJig } from "@/lib/api";
...
const ViewJig = () => {
  ...
  const [jigData, setJigData] = React.useState<Stages[]>([]);
  ...
  const columns = [
    ...
    {
      name: "Jig Category",
      selector: (row: Stages) => row?.jigCategory,
      sortable: true,
    },
    {
      name: "Created At",
