...
const RoomMap = () => {
  ...
  const submitForm = async () => {
    ...
    try {
      ...
      } else throw new Error(result?.message || "Failed to create room plan");
    } catch (error: any) {
      ...
      <div className="rounded-3xl bg-white p-8 shadow-xl ring-1 ring-black/5 dark:bg-boxdark dark:ring-strokedark transition-all">
        <div className="mb-8 border-b border-gray-100 pb-6 dark:border-strokedark">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white uppercase">Create New Room</h1>
              <p className="mt-0.5 text-[13px] text-gray-500 font-normal italic">Configure floor levels, production lines, and workstation capacity.</p>
            </div>
          </div>
        </div>
